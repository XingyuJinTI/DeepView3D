    ...
    def __init__(self, finetune=False, weights = None, weights_path = None, num_classes = 12):
        ...
        if weights == 'lua':
            ...
            if num_classes == 3 and (state_dict['22.1.weight'].size()[0] > 360*3):
                azim.weight.data.copy_( torch.cat([  state_dict['22.1.weight'][360*6:360*7, :],  state_dict['22.1.weight'][360*5:360*6, :], state_dict['22.1.weight'][360*8:360*9, :] ], dim = 0) )
                ...
                azim.weight.data.copy_(state_dict['22.1.weight'][360*6:360*7, :])
                elev.weight.data.copy_(state_dict['24.1.weight'][360*6:360*7, :])
                tilt.weight.data.copy_(state_dict['26.1.weight'][360*6:360*7, :])
                azim.bias.data.copy_(state_dict['22.1.bias'][360*6:360*7])
                elev.bias.data.copy_(state_dict['24.1.bias'][360*6:360*7])
                tilt.bias.data.copy_(state_dict['26.1.bias'][360*6:360*7])
            else:
