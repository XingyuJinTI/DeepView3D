...
trained_model=./downloads/models/tvmarrnet_vec_add.pt
...
outdir=./output/tvmarrnet_vec_add_std_val
pred_thresh=0.3
if [ $# -ge 3 ]; then
    pred_thresh="$3"
    outdir=./output/tvmarrnet_vec_add_std_val_${pred_thresh}
